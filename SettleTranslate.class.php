...
class SettleTranslate {
	...
	public static function renderForeign( $parser ) {
		...
		$html .= '<div style="display: none;" class="foreign-render-list" data-currenttitle="'.$currentTitle.'" data-selfsource="'.$selfSource.'">';
	...
	public static function renderLink( $parser ) {
		...
		$html .= $parser->insertStripItem(
			'<a id="translate-link" href="#" type="button" class="btn btn-cyanide pull-right" data-toggle="modal" data-target=".translate-window"><i class="fa fa-language" ></i> '
